...
class MetaNRU(nn.Module):
    ...
    def _add_cell(self, input_size, hidden_size):
        ...
        self._Cells.append(MetaNRUCell(self._device, input_size, hidden_size,
