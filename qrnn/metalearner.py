...
class MetaLearner(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, n_learner_params, use_qrnn):
        ...
        if(use_qrnn):
            self.lstm = QRNN(input_size=input_size, hidden_size=hidden_size, num_layers=1, dropout=0.4)
        else:
